...
//   callback(null,'./../frontend/public/test/');
//   },
...
// })
// //second endpoint
// var cpUpload = upload.fields([{ name:'picone', maxCount: 1 }, { name: 'pictwo', maxCount: 1 }]);


// router.route('/add').post(upload.fields([{ name:'picone', maxCount: 1 }, { name: 'pictwo', maxCount: 1 }]),(req, res) => {
//   const testname = req.body.testname;
//   const picone=req.file;
//   const pictwo=req.file;
