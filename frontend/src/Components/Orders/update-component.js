...
const UpdateOrder=props=> {
    ...
    setAgentpayment(res.data.agentPayment),
    setAuctionsheetid(res.data.auctionSheetid),
    setShippingCost(res.data.shippingCost),
...
.catch(error =>console.log(error))
  ...
  const onChangeFi=e=>{
    ...
    const changeonClick = e => {
        ...
        axios
        .put(`http://localhost:5001/orders/update/${props.match.params.id}`,formData)
    ...
    return (
        ...
        <div className="col-10 border bg-info mt-5 text-white rounded p-5">
          <h3 className="mb-3 text-center">Update Order</h3>
