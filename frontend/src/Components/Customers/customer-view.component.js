    ...
    <div className="modal-content">
      ...
      <div className="modal-body">
        <div className="container border border-primary rounded pb-5 pt-5 mt-2 mb-2">
          <div>
          <h4 className="bg-primary text-white p-2 mb-3">ADD CUSTOMER</h4>
          </div>
          <div className="col-9">
            <CreateCustomer/>
            </div>
        ...
        <Container className={classes.cardGrid} maxWidth="md">
          ...
          <Grid container spacing={4}>
            {
              !customers.length ? <div className={classes.root}>
              ...
              <Grid item key={key} xs={12} sm={6} md={4}>
                ...
                <Card className={classes.card}>
                  ...
                  <CardContent className={classes.cardContent}>
                    ...
                    <Link style={{textDecoration:"none"}} to={`/customer/${customer._id}`} >
                    {customer.username}
                  ...
                  <CardActions>
                    <Link to={`/update/${customer._id}`} className="btn btn-primary">
                      Update
                    </Link>
                    <Button onClick={()=>deleteCustomer(customer._id)} size="small" color="secondary">
                      delete
                    </Button>
                  </CardActions>
                </Card>
