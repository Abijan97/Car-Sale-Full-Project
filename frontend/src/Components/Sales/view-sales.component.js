...
<div className="row mt-5">
        ...
        { !sales.length ? <div className={classes.root}>
        ...
        sales.map((sale,key)=>(
              ...
              <AccordionSummary
                ...
                id="panel1a-header"
              >
                <Typography className={classes.heading}>Sale Num : {sale.saleNo}</Typography>
              </AccordionSummary>
              <AccordionDetails>
...
<div className="input-group-prepend">
  ...
  <div className="col-6 mb-3">
  <label htmlFor="insurancepay" className="">Luxury Taxes</label>
 <div className="input-group">
<div className="input-group-prepend">
  <div className="input-group-text">Rs.</div>
...
<div className="form-group mb-3">
  <input onClick={()=>deleteSale(sale._id)} value="Delete Order" className="btn btn-warning" />
</div>
</form>
